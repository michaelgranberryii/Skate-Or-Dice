...
class Dice {
    let orientation : Array = [#imageLiteral(resourceName: "Frontside"),#imageLiteral(resourceName: "Backside"),#imageLiteral(resourceName: "Skate Or Dice"),#imageLiteral(resourceName: "Skateboards")] // image literals
